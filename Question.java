...
public class Question extends JFrame {
	...
	String arr[][] = {
			...
			{ "The \\u0021 article referred to as a", "Unicode escape sequence", "Octal escape", "Hexadecimal",
					"Line feed", "Unicode escape sequence" },
			{ "_____ is used to find and fix bugs in the Java programs.", "JVM", "JRE", "JDK", "JDB", "JDB" },
			{ "What is the return type of the hashCode() method in the Object class?", "Object", "int", "long", "void",
					"int" },
	};
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					Question frame = new Question(examDurationSeconds);
		...
		timer = new Timer(1000, new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (countdownSeconds >= 0) {
					...
					timer.stop();
					JOptionPane.showMessageDialog(Question.this, "Time's up!");
